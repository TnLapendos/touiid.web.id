...
<html ......deface coded by Tn.Lapendos from team id-rew>
<head>
 <meta http-equiv="Content-Type" content="text/HTML; charset=utf-8" />
   <link rel="shortcut icon" href="https://i.ibb.co/wgSD2wJ/FB-IMG-16070771184535966.jpg">
   <title> -:Hacked By Tn.Lapendos:- </title>
   <meta property="og:title" content="-:Hacked By TnLapendos:-">
   <meta property="og:description" content=" Indonesian Cyber Research and Empower Wing "> 
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
   <meta property="og:image" content="https://i.ibb.co/wgSD2wJ/FB-IMG-16070771184535966.jpg"> 
    <iframe frameborder="0" height="1" width="1" loop="true" allow="autoplay" src="https://www.customerreviews.pk/slides/ha.mp3"></iframe></html>
...
<style type="text/css"> 
   body { 
      background-image: url('https://media.tumblr.com/c838dd887608a325eaae477ffa4dd2b7/tumblr_myrxsem7AC1s8tqb9o1_500.gif');
  ...
  background-position:center;
   ...
   #greets { 		width: 820px; 		border-style: outset; 	} 
   #footer { 		font-size: 9pt; 		opacity: .7; 	} 	 	.glow { 	
   text-shadow: 0 0 10px #F59700; 		font-family: "Black Ops One"; 	} 	 
   .blueglow { 		text-shadow:0px 0px 1px aqua,0px 0px 1px aqua,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px aqua; 		font-family: "Black Ops One" 	} 	 	
   .redglow { 		text-shadow: 0 0 10px yellow; 		font-family: "Black Ops One" 	} 	 	
   .whiteglow { 	text-shadow:0px 0px 1px green,0px 0px 1px green,0px 0px 1px aqua,0px 0px 1px green,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px red,0px 0px 1px  green; 		font-family: "Black Ops One"; 	}
   </style>
   
<br><span class="wglow" style="font-family: Courier;"><b> </b></span><a href=""target="blank"><class="evil" onclick="meow()"><b><span style="color: RED;"></span></b></button></a>
<center><img style="width:300px;" src="https://i.ibb.co/7JX9VvL/ID-CREW-SQL-XSS-CHALLENGE-20201126-112655.jpg"></center>
<br>
<center><font size="5" color="white" face="courier new"><b>Hacked</font><font size="5" color="WHITE" face="courier new"> By </font><font size="5" color="white" face="courier new"><b> Tn.Lapendos</b></font><br><br>
<b> <CENTER>
  <span class="whiteglow" face="Black Ops One" style="font-size: 20pt;">
<SCRIPT>
farbbibliothek = new Array(); 
farbbibliothek[0] = new Array("#FF9933","#FF1100","#FF2200","#FF3300","#FF4400","#FF5500","#FF6600","#FF7700","#FF8800","#FF9900","#FFaa00","#FFbb00","#FFcc00","#FFdd00","#FFee00","#FFff00","#FFee00","#FFdd00","#FFcc00","#FFbb00","#FFaa00","#FF9900","#FF8800","#FF7700","#FF6600","#FF5500","#FF4400","#FF3300","#FF2200","#FF1100"); 



farbbibliothek[1] = new Array("#FF9933","#BLUE","#WHITE","#138808"); 
...
<p align="center">
<p align="center">&nbsp;</p>
<SCRIPT TYPE="text/javascript"> <!-- //Disable right click script //visit http://www.rainbow.arch.scriptmania.com/scripts/ var message="Sorry, right-click has been disabled"; /////////////////////////////////// function clickIE() {if (document.all) {(message);return false;}} function clickNS(e) {if (document.layers||(document.getElementById&&!document.all)) { if (e.which==2||e.which==3) {(message);return false;}}} if (document.layers) {document.captureEvents(Event.MOUSEDOWN);document.onmousedown=clickNS;} else{document.onmouseup=clickNS;document.oncontextmenu=clickIE;} document.oncontextmenu=new Function("return false") // --> </SCRIPT> <body onkeydown="return false">
...
<center><font face="courier new" color="orange " size="4"><b>
<font face="courier new" color="white " size="4">I</font>ndonesian <font face="courier new" color="white " size="4">C</font>yber <font face="courier new" color="white " size="4">R</font>esearch and <font face="courier new" color="white " size="4">E</font>mpower <font face="courier new" color="white " size="4">W</font>ing </font>
<br><br></center>
<center><font face="courier new" color="white" size="4">YOUR WEBSITE HAS BEEN HACKED</font></center>
<font face="courier new" color="white" size="4"><br><br>
<center>sorry if this harms you,I don't mean to want to be famous, but I just play games :D
<br><br>
<font face="courier new" color="red" size="4">
<br> Okay Thanks for you <br><br>
<font face="courier new" color="green" size="4">Dont forgot my name its <br>
<font face="courier new" color="white" size="4"> Tn.Lapendos 
<br><br>

</font>
<br>
<br>
<font face="courier new" color="white" size="4">Team Indonesian Cyber Research and Empower Wing (ID-CREW) </font>
<br><br>
<font face="courier new" color=" #FF9933;" size="4">MY FRIENDS:  (TnLapendos) -ZOHA - AKBAR - RAHMAT - LUTFIE-404 - IYAN - SESATH - IKHSAN - CAISAR MUDA - ANDRO - DENNIS SEC - AYES </font>
<div align="center" class="style11">
<span style="color: white;"><span style="font-size: Small;"><span style="color: white;"><span style="font-size: Small;"><span style="color: #FF9933;">Greets To:  - SUNDAXPLOIT - GRAYHAT SCHOOL OF HACKERS - SEKIREIXPLOITER - WHITE HAT HEROES - LAMONGAN ERROR SYSTEM - ALL HACKER INDONESIAN<span style="color: green;">  </span></span></span></span></span></span></span></span></div>
<br>

<a href="https://xnxx.com<"><button>My Account</button></a><br /><br />
<object data="http://flash-mp3-player.net/medias/player_mp3.swf" width="0" height="0" type="application/x-shockwave-flash"><param value="#ffffff" name="bgcolor" /><center></object><object data="http://flash-mp3-player.net/medias/player_mp3.swf" width="0" height="0" type="application/x-shockwave-flash"><param value="#ffffff" name="bgcolor" /><param value="mp3=http://wilddave.com/fluid1/fluidgalleries/js/anu.mp3&amp;loop=1&amp;autoplay=1&amp;volume=125" name="FlashVars" /></object>
...
<span style='font: 100px>
 body{
  ...
  if(charIndex%2==1){
    ...
    <script type="text/javascript" src="https://cdn.rawgit.com/bungfrangki/efeksalju/2a7805c7/daun-berguguran.js"></script>
<script type="text/javascript">
